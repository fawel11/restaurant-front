<template>
    <div class="header">
        ...
        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/category">Category</router-link>
            <router-link @click="scrollToTop()" to="/item">Item</router-link>
            <router-link @click="scrollToTop()" to="/discount">Discount</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
