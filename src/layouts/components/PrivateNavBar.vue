<template>
    <div class="header">
        ...
        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">Category</router-link>
            <router-link @click="scrollToTop()" to="/about">Item</router-link>
            <router-link @click="scrollToTop()" to="/promotions">Discount</router-link>
        </nav>
