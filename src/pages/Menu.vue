                    ...
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <div class="price">
                                    ${{ parseFloat(f.computed_discount ?? f.price) }}
                                    <span v-if="parseFloat(f.computed_discount)">${{ parseFloat(f.price) }}</span>
                                </div>
    ...
    computed: {
        ...
        filterFoods: function () {
            return this.allFoods.filter((f) => {
                const lowercasedName = (this.foodObj.name || "").toLowerCase();
                const lowercasedCategory = (this.foodObj.category || "").toLowerCase();

                return f.name.toLowerCase().includes(lowercasedName) &&
                    (f.category.includes(this.foodObj.category) || lowercasedCategory === "all" || lowercasedCategory === "") &&
